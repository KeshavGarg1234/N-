    ...
    const joinAndSetupPresence = async () => {
        try {
            await runTransaction(firestore, async (transaction) => {
                ...
                // If room is locked, only allow existing users or the host to join
            ...
            // Don't throw here, just handle it gracefully
            toast({
              variant: "destructive",
              title: "Connection Error",
              description: "Could not establish room presence. Please refresh."
            });
        }
    };
